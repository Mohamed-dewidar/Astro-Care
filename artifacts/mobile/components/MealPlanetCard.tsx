...
export function MealPlanetCard({
  meal,
  onComplete,
  onSkip,
  onUpdateTime,
  ...
  return (
    <GlassCard style={styles.card} glowColor={glowColor}>
      ...
      >
        <View style={styles.row}>
          <View style={styles.planetContainer}>
            ...
            {isCompleted && (
              <View
                style={[styles.ring, { borderColor: "#22C55E", opacity: 0.8 }]}
              />
            )}
            {isMissed && (
              <View
                style={[styles.ring, { borderColor: "#EF4444", opacity: 0.6 }]}
              />
            )}
          ...
          <View style={styles.timeContainer}>
            ...
            {isCompleted && (
              <Text style={[styles.countdown, { color: "#22C55E" }]}>Done</Text>
            )}
            {isSkipped && (
              <Text style={[styles.countdown, { color: "#94A3B8" }]}>
                Skipped
              </Text>
            )}
          </View>
      ...
      {!isCompleted && !isSkipped && (onUpdateTime || onDelete) && (
      ...
      {(isCompleted || isSkipped) && onUndo && (
        <View style={styles.actions}>
          ...
          >
            <Ionicons name="arrow-undo-outline" size={16} color="#22D3EE" />
            <Text style={[styles.actionText, { color: "#22D3EE" }]}>Undo</Text>
          </Pressable>
        </View>
      )}
    </GlassCard>
